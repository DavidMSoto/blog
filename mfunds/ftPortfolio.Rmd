...
baseURL <- "https://markets.ft.com/data/equities/ajax/get-historical-prices?startDate=2016/01/01&endDate=2017/09/19&symbol="
...
setwd("~/dataScience/blog/mfunds/input/")
 ...
 saveRDS(df, file.path(getwd(), "ftfunds.rds"))
...
funds$fecha_dato <- as.Date(funds$date, format="%a, %b %d, %Y")
...
require(PerformanceAnalytics)
  ...
  getSymbols("TSLA",src="google")


data=TSLA[,4]


chartSeries(Z.x, TA=NULL)
